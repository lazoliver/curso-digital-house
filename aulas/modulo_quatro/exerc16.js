...
//Escreva uma função calculaValorDevido: function calculaValorDevido(pesoDaRoupaSuja); A função recebe como parâmetro o peso de roupa suja (em quilos) e deve retornar o valor a ser cobrado do cliente.
